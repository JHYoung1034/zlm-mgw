...
#define TraceLDev(dev) TraceL << (dev)->sn() << " |";
#define DebugLDev(dev) DebugL << (dev)->sn() << " |";
#define InfoLDev(dev) InfoL << (dev)->sn() << " |";
#define WarnLDev(dev) WarnL << (dev)->sn() << " |";
#define ErrorLDev(dev) ErrorL << (dev)->sn() << " |";
