...
// 某个流观看人数变化时触发通知，通知当前观看人数
extern const std::string kBroadcastPlayersChanged;
#define BroadcastPlayersChangedArgs MediaSource &sender

/////////////////////////////////////////////////////////////////////////////
// 设备上线/下线通知
extern const std::string kBroadcastDeviceOnline;
#define BroadcastDeviceOnlineArgs const bool &enable, const Device::DeviceConfig &config

//设备开启/停止推流通知
extern const std::string kBroadcastPush;
#define BroadcastPushArgs const bool &enable, const std::string &sn, uint32_t &channel, const std::string &url

//推流状态通知
extern const std::string kBroadcastStreamStatus;
#define BroadcastStreamStatusArgs const std::string &stream_id, const int &status, const int &start_time, const int &err_code
...
namespace Mgw {
extern const std::string kMaxPushers;
extern const std::string kMaxBitrate;
extern const std::string kMaxBitrate4K;
extern const std::string kDeviceKeepAliveSec;
extern const std::string kDelayStreamSec;
extern const std::string kMaxPlayers;
extern const std::string kStreamTunnel;
