...
const string kBroadcastPlayersChanged = "kBroadcastPlayersChanged";
const string kBroadcastDeviceOnline = "kBroadcastDeviceOnline";
const string kBroadcastPush = "kBroadcastPush";
const string kBroadcastStreamStatus = "kBroadcastStreamStatus";
...
namespace SrtSrv {
#define SRT_SRV_FIELD "srt_srv."
const string kPort              = SRT_SRV_FIELD "port";

static onceToken token([]() {
    mINI::Instance()[kPort]     = 60003;
});

}

namespace Mgw {
#define MGW_FIELD "mgw."
const string kMaxPushers          = MGW_FIELD "proxyOutputs";
const string kMaxBitrate            = MGW_FIELD "maxBitrate";
const string kMaxBitrate4K          = MGW_FIELD "maxBitrate4K";
const string kDeviceKeepAliveSec    = MGW_FIELD "deviceKeepAliveSec";
const string kDelayStreamSec        = MGW_FIELD "delayStreamSec";
const string kMaxPlayers            = MGW_FIELD "maxPlayers";
const string kStreamTunnel          = MGW_FIELD "streamTunnel";
...
static onceToken token([]() {
    ...
    mINI::Instance()[kMaxBitrate]           = 6144;
    mINI::Instance()[kMaxBitrate4K]         = 10240;
    mINI::Instance()[kDeviceKeepAliveSec]   = 300;
    mINI::Instance()[kDelayStreamSec]       = 15;
