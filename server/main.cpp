...
#include "../mgw/message/MessageClient.h"
#include "../mgw/message/MessageSession.h"
#include "../mgw/core/EventProcess.h"
#endif
...
int start_main(int argc,char *argv[]) {
    {
        ...
        auto mgwSrv = std::make_shared<TcpServer>();
#endif
        ...
        try {
            ...
            mgwSrv->start<WebSocketSessionBase<MessageSessionCreator,
                    HttpSession, WebSocketHeader::BINARY> >(wsSrvPort);
#endif//defined(ENABLE_MGW)
